...
class SelfLearner:
    ...
    def load_weights(self):
        """Load chapter weights from file"""
    ...
    def analyze_news(self, news_texts, direction):
        """Analyze if news supports the prediction direction"""
    ...
    def auto_learn_from_news(self, symbol, predicted_action):
        """Auto-learn by fetching news and scoring sentiment"""
