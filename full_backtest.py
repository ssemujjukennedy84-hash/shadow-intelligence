"""
Full Sports Backtest - Uses ALL system components
"""
...
def main():
    print("=" * 60)
    print("🔶 FULL SPORTS BACKTEST")
    print("   Sun Tzu + Quant + Self-Learning")
    print("=" * 60)
    
    tester = FullSportsBacktester()
